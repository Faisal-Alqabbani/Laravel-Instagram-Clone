<div>
    ...
    <x-jet-form-section submit="createApiToken">
        ...
        <x-slot name="actions">
            <x-jet-action-message class="me-3" on="created">
                {{ __('Created.') }}
    ...
    <x-jet-dialog-modal wire:model="displayingToken">
        ...
        <x-slot name="content">
            ...
            <x-jet-input x-ref="plaintextToken" type="text" readonly :value="$plainTextToken"
                class="mt-4 bg-gray-100 pe-4 py-2 rounded font-mono text-sm text-gray-500 w-full"
    ...
    <x-jet-confirmation-modal wire:model="confirmingApiTokenDeletion">
        ...
        <x-slot name="footer">
            ...
            <x-jet-danger-button class="ms-3" wire:click="deleteApiToken" wire:loading.attr="disabled">
                {{ __('Delete') }}
            </x-jet-danger-button>
        </x-slot>
